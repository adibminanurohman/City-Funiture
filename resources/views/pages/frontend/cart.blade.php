      ...
      <div class="container mx-auto px-4">
        <div class="flex -mx-4 flex-wrap">
          <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
            ...
            >
              <h3 class="text-2xl">Keranjang Saya</h3>
            </div>
            ...
            @empty
              <p id="cart-empty" class="text-center py-8">
                ...
                <a href="{{ route('index') }}" class="underline">Beli Sekarang</a>
              </p>
            @endforelse
            ...
            <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
              <form action="{{ route('checkout') }}" method="POST">
                ...
                <div class="flex flex-start mb-6">
                  <h3 class="text-2xl">Detail Pengiriman</h3>
                </div>
                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/images/content/logo-jne.png"
                          alt="Logo jne"
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/images/content/sicepat-logo.png"
                          alt="Logo sicepat"
                          class="object-contain max-h-full"
                        />
                      </button>
